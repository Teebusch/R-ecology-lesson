...
```{r layout="l-body", echo=FALSE, fig.cap="Set 'Save workspace to .RData on exit' to 'Never'"}
...
```{r layout="l-body", echo=FALSE, fig.cap="What your working directory should look like at the beginning of this lesson"}
...
understand.](img/rstudioredx.png)
